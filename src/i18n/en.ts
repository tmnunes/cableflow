...
export const en = {
  ...
  summary: {
    ...
    byZone: 'By zone (description)',
    byZoneHint: 'Cable metres per circuit type for each zone, including conduit length.',
    zone: 'Zone',
    circuit: 'Circuit',
    section: 'Section',
    conduitMeters: 'Conduit (m)',
    cableMeters: 'Cable (m)',
    zoneTotal: 'Zone total',
    unnamedZone: 'Unnamed zone',
    cableShort: 'cable',
    conduitShort: 'conduit',
  ...
  electricalCircuits: {
    ...
    installationMethodHint:
      'Chooses which current-carrying capacity table to use. Add or rename methods in',
    suggested: 'Suggested',
    protectionSuggestion: 'Suggested protection: {{protection}} → {{material}}',
    noLinkedMaterial: 'no catalog material linked yet',
    duplicate: 'Duplicate circuit',
    duplicated: 'Circuit duplicated.',
    expand: 'Expand circuit',
    collapse: 'Collapse circuit',
  ...
  electricalRules: {
    ...
    installationMethodsHint:
      'These labels appear on each circuit. Pair each method with an ampacity table below — empty tables are never invented automatically.',
    addInstallationMethod: 'Add method',
    newInstallationMethod: 'New installation method',
    methodName: 'Name',
    methodNotes: 'Notes',
    ampacityMethod: 'Ampacity table applies to method',
