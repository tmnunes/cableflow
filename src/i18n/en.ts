...
export const en = {
  ...
  projects: {
    ...
    projectsQuotesDataHint:
      'Contains projects, cable runs, project materials and quotes in one structured JSON file.',
  ...
  settings: {
    ...
    dataTitle: 'Export & import',
    dataDescription:
      'Export or import one JSON file containing company settings, materials and suppliers. The file uses the cableflow/settings-materials-suppliers schema.',
    settingsMaterialsSuppliersData: 'Settings, materials & suppliers',
    settingsMaterialsSuppliersDataHint:
      'Contains company profile, quote numbering, materials catalog and suppliers in one structured JSON file.',
